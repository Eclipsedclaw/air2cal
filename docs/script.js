  ...
  function buildICS(flightsArr) {
    ...
    for (const f of flightsArr) {
      ...
      const event = [
        ...
        `DESCRIPTION:${icsEscape(description + '\n\nGenerated by Air2Cal - Flight Calendar Generator, URL:https://eclipsedclaw.github.io/air2cal/')}`,
        'END:VEVENT'
      ].join('\r\n') + '\r\n';

      ics += event;
    }
    ics += '\r\n\r\nCOMMENT:Generated by Air2Cal - Flight Calendar Generator, URL:https://eclipsedclaw.github.io/air2cal/\r\n';
    ics += 'END:VCALENDAR\r\n';
    return ics;
  }
